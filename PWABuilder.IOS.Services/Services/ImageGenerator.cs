...
public class ImageGenerator
{
        ...
        ILogger<ImageGenerator> logger)
    {
        ...
        this.imageGeneratorServiceUrl = new Uri(appSettings.ImageGeneratorApiUrl);
        this.logger = logger;
    }
    ...
    private async Task<Uri> CreateIOSImagesZip(byte[] image, double padding, string backgroundColor)
    {
        ...
        var imagesResult = JsonSerializer.Deserialize(imagesResponseString, AppJsonSerializerContext.Default.ImageGeneratorServiceResult);
    ...
    internal class ImageGeneratorServiceResult
    {
...
[JsonSerializable(typeof(ImageGenerator.ImageGeneratorServiceResult))]
